  ...
  questions: [
    {
      ...
      answers: ["COBOL", "Rust", "Assembly", "Prolog"],
      correctAnswer: "Assembly",
    },
    {
      question:
        "What is information provided to the computer from a person or from another computer, through devices such as the keyboard, mouse or touch screen?",
      answers: ["Input", "Output", "Keystrokes", "Gibberish"],
      correctAnswer: "Input",
    },
    {
      question:
        "What is a trigger from user input or from the computer such as a mouse click, a key press, or a timer?",
      answers: ["Input", "Event", "Listener", "Backlog"],
      correctAnswer: "Event",
    },
    {
      question:
        "What is a prioritized list of features or user stories to add to a program?",
      answers: ["Input", "Traffic Jam", "Listener", "Backlog"],
      correctAnswer: "Backlog",
    },
    {
      question:
        "What is information that has continuous values instead of jumping from one value without passing through the values between?",
      answers: ["Digital", "Method", "Analog", "Optical"],
      correctAnswer: "Analog",
    },
    {
      question:
        "What are conditional expressions that are either true or false?",
      answers: [
        "True",
        "Tertary Operators",
    ...
    },
    {
      ...
      answers: ["Float", "Integer", "Real Number", "Precision"],
      correctAnswer: "Float",
    },
    {
      question:
        "What is the network of computer networks which communicate through common protocols for accessing information contained inside the computers?",
      answers: [
        "World Wide Web",
        "Internet",
        "Wide Area Network",
    ...
    {
      question:
        "What is a computer program that provides services to other computer programs (and their users) in the same or other computers, it can hold the data/web contet and delivers the web page?",
      answers: ["Server", "Local Host", "Mainframe", "Tandy 1000"],
      correctAnswer: "Server",
    },
    {
      question:
        "What is a group of computers that keep track of the IP address for every domain name on the internet?",
      answers: ["DNS", "IPv6", "IPv4", "MAC"],
      correctAnswer: "DNS",
    },
    {
      question:
        "What is a procedure to follow, especially using iteration and conditionals?",
      answers: ["Algorithm", "For Loop", "Lambda", "Polymorphism"],
      correctAnswer: "Algorithm",
    },
    {
      question:
        "What is the process of taking a finished product and figuring out how it works, deducing how software works based on how it behaves called?",
      answers: [
        "A Felony",
        "Tech Theft",
        "Reverse Engieering",
    ...
    {
      question:
        "What is a 2D image or animatio that is integrated into a larger scene called?",
      answers: ["Picture", "Image", "Meme", "Sprite"],
    ...
    },
    {
      ...
      answers: ["Rear Admiral", "Captain", "Corporal", "Ensign"],
